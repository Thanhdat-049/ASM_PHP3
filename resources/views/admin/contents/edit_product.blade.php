                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="file" class="form-control" name="image" id="imageInput1"
                                            value="{{ $data->image }}">
                                        <img id="imagePreview" src="{{ asset('upload') }}/{{ $data->image }}"
                                            alt="Image Preview" width="100px" height="80px"
                                        ...
                                        <div class="image-container">
                                            @foreach ($image as $item)
                                                <img id="imagePreview3"
                                                    src="{{ asset('upload') }}/{{ $item->image_description }}"
                                                    width="100px" height="80px" style="display: block; margin: 5px;">
                                            @endforeach
                                        </div>
                                    ...
                                    <script>
                                        document.getElementById('imageInput').addEventListener('change', function(event) {
                                            ...
                                            // Ẩn tất cả các ảnh có id là imagePreview3
                                            const oldImages = document.querySelectorAll('#imagePreview3');

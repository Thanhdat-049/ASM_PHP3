...
<script src="{{ asset('assets_admin/libs/flot/jquery.flot.crosshair.j') }}s"></script>
<script src="{{ asset('assets_admin/libs/flot.tooltip/js/jquery.flot.tooltip.min.js') }}"></script>
<script src="{{ asset('dist/js/pages/chart/chart-page-init.js') }}"></script>
<script src="{{ asset('assets_admin/libs/chart/matrix.interface.js') }}"></script>
<script src="{{ asset('assets_admin/libs/chart/excanvas.min.js') }}"></script>
<script src="{{ asset('assets_admin/libs/chart/jquery.peity.min.js') }}"></script>
<script src="{{ asset('assets_admin/libs/chart/matrix.charts.js') }}"></script>
<script src="{{ asset('assets_admin/libs/chart/jquery.flot.pie.min.js') }}"></script>
<script src="{{ asset('assets_admin/libs/chart/turning-series.js') }}"></script>
<script src="{{ asset('dist/js/pages/chart/chart-page-init.js') }}"></script>
<script src="{{ asset('assets_admin/libs/jquery-steps/build/jquery.steps.min.js') }}"></script>
<script src="{{ asset('assets_admin/libs/jquery-validation/dist/jquery.validate.min.js') }}"></script>
...
<script src="{{ asset('assets_admin/libs/quill/dist/quill.mn.js') }}"></script>
